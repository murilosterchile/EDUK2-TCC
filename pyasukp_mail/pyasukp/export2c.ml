...
(* $Id: export2c.ml,v 1.2 2005/02/25 08:51:29 poirriez Exp $ *)
...
(*export2c.ml*)
(*
  This code is here to allow exportation of caml code to c code.
*)

let _ = Callback.register "pyasukp" Eduk.resolve_array
let _ = Callback.register "items_of_file" Edukio.items_of_file
